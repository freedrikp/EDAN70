...
Now that we had coordinates in a much more manageable represenation we could visualize the data for ourself and we could use standard mathematical formulas in order to work with each measurement. As we needed to manually classify measurements in order to feed these to the classifier as a starting ground it was vital that we could easily plot the measurements. This was easily done in Matlab or Octave when we had our cartesian coordinates. Below follows some example plots:


\begin{figure}[h]
\centering
\includegrahpics[]{presimg/chair.jpg}
\caption{}
\end{figure}

\begin{figure}[h]
\centering
\includegrahpics[]{presimg/doorhalf.jpg}
\caption{}
\end{figure}

\begin{figure}[h]
\centering
\includegrahpics[]{presimg/doorfull.jpg}
\caption{}
\end{figure}

\begin{figure}[h]
\centering
\includegrahpics[]{presimg/human.jpg}
\caption{}
\end{figure}
